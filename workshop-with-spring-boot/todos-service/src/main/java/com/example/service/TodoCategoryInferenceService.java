...
public class TodoCategoryInferenceService {
    ...
    // // public TodoCategoryInferenceService(ObjectProvider<ChatClient.Builder>
    // chatClientBuilderProvider) {
    // // ChatClient.Builder chatClientBuilder =
    // chatClientBuilderProvider.getIfAvailable();
    // // this.chatClient = (chatClientBuilder != null) ? chatClientBuilder.build()
    // : null;
    // // }
    ...
    // if (containsAny(text, "meeting", "deadline", "office", "project", "client",
    // "report", "work")) {
    // return TodoCategory.WORK;
    // }
    // if (containsAny(text, "gym", "workout", "exercise", "doctor", "meditation",
    // "health", "diet")) {
    // return TodoCategory.HEALTH;
    // }
    // if (containsAny(text, "movie", "music", "game", "concert", "netflix",
    // "entertainment")) {
    // return TodoCategory.ENTERTAINMENT;
    // }
    // if (containsAny(text, "family", "friend", "home", "personal", "birthday",
    // "call mom", "call dad")) {
